  ...
  return (
    <div className="overflow-x-hidden bg-white text-slate-900 md:bg-[linear-gradient(180deg,#fff7ed_0%,#fffaf5_14%,#ffffff_34%,#fff7ed_64%,#fff1f2_100%)] dark:bg-[radial-gradient(circle_at_15%_20%,rgba(255,124,64,0.12),transparent_30%),radial-gradient(circle_at_80%_10%,rgba(244,114,182,0.12),transparent_26%),linear-gradient(180deg,#0f172a_0%,#0b1225_45%,#0a1020_100%)] dark:text-slate-50">
      <section className="relative isolate overflow-hidden [content-visibility:auto] [contain-intrinsic-size:1px_900px]">
        ...
        <div className="relative mx-auto grid min-h-[calc(100vh-5rem)] max-w-6xl items-center gap-10 px-5 py-12 md:max-w-7xl md:grid-cols-[1.05fr_0.95fr] md:px-6 md:py-16 lg:px-10 lg:py-20">
          <motion.div
            {...motionReveal}
            className="space-y-8"
          >
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <Link
                to="/menu"
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-slate-950 px-7 py-3.5 text-sm font-semibold text-white shadow-[0_18px_50px_-18px_rgba(15,23,42,0.7)] transition-transform duration-300 hover:-translate-y-0.5 w-full sm:w-auto"
              >
                Explore Menu
          ...
          <motion.div
            ...
            transition={prefersReducedMotion ? { duration: 0 } : { duration: 0.8, delay: 0.15 }}
            className="relative"
          >
          ...
          {categories.map((category, index) => {
            ...
            return (
              <motion.div
                ...
                transition={prefersReducedMotion ? { duration: 0 } : { delay: index * 0.12 }}
