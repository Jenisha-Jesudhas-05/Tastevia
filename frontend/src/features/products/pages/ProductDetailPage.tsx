...
import { Star, ShoppingCart, ChevronLeft, ChevronRight, Shield, Truck, Clock } from "lucide-react";
...
export default function ProductDetailPage() {
  ...
  return (
    <div className="bg-background/95 pb-24 pt-10">
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-3 text-sm">
              ...
              <div className="flex items-center gap-1 text-yellow-500">
                ...
                <span className="text-foreground/80">{product.rating || 4.5} • Popular choice</span>
              </div>
            </div>
          ...
          <div className="mt-16">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h2 className="mt-2 text-2xl font-bold text-foreground">Related Meals</h2>
              </div>
            </div>
